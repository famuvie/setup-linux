...
sudo apt-get install apt-transport-https freemind guake gnome-do gnome-do-plugins keepass2 unison unison-gtk gftp meld playonlinux virtualbox virtualbox-qt umbrello pdftk recode ssh sshfs gtg okular audacity pdfshuffler pandoc xdotool xournal ispell xclip git-all timeshift stow zsh
