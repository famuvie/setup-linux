...
sudo apt-get install freemind guake gnome-do unison unison-gtk gftp meld playonlinux virtualbox umbrello pdftk recode ssh sshfs gtg okular audacity pdfshuffler pandoc xournal ispell xclip git-all timeshift stow zsh
